   ...
   <script src="/javascript/bootstrap-dropdownhover.min.js"></script>
	...
	<style>
		...
		.ch-desk-messenger {
			...
			font-family: NotoSansKR, NotoSansJP, -apple-system, BlinkMacSystemFont, "Helvetica Neue", "?? ??", "Yu Gothic", "Segoe UI", Roboto, "system-ui", "sans-serif" !important;
...
// 		                            	temp += "<a class='btn btn-info' role='button' href='/purchase/updateTranCodeByProd?prodNo="+list[i].prodNo+"&menu="+menu+"' onclick='return confirm('선택 하신 상품 "+list[i].prodName+"을 배송 하시겠습니까?')'>배송하기</a>";
			...
			$("#messenger-btn").on("click", ()=>{
				console.log("클릭");
				$(".ch-messenger-hidden").attr("class", "ch-desk-messenger rightPosition");
			})
		})
 	</script>
</head>
...
<body bgcolor="#ffffff" text="#000000" data-menu="${param.menu}">
   ...
   <!-- chatting -->
   <div id="messenger-btn" class="chatting-btn">버튼입니다</span></div>
